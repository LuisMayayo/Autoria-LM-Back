...
public class CocheAutoriaAutoriaController : ControllerBase
{
    /// <summary>
    /// Servicio utilizado para gestionar la lógica de negocio.
    /// </summary>
    private readonly ICocheAutoriaService _service;
    
    /// <summary>
    /// Constructor que inyecta el servicio.
    /// </summary>
    /// <param name="service">Servicio de ProductoAutoria.</param>
    public CocheAutoriaAutoriaController(ICocheAutoriaService service)
    {
        _service = service;
    }
    ...
    [HttpGet]
    public ActionResult<IEnumerable<CocheAutoria>> Get()
    {
    ...
    [HttpGet("{id}")]
    public ActionResult<CocheAutoria> Get(int id)
    {
    ...
    [HttpPost]
    public ActionResult Post([FromBody] CocheAutoria coche)
    {
    ...
    [HttpPut("{id}")]
    public ActionResult Put(int id, [FromBody] CocheAutoria coche)
    {
        if (id != coche.Id)
